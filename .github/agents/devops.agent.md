---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-config, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-config`.
...
- Checkout local: `app-community/modules/controleonline/ui-config`
